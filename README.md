...
**However, due to api usage limitation please do the manual approach if possible(clone->change-->pull request)**
---

## Profile Add/Update

**Option 1 (Recommended, manual):** Fork this repository and create a new folder with your name (e.g., `Hamza-Hanif`) in `content/authors/`. Inside that folder, add:
